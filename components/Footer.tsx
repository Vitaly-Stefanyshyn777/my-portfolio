...
const socialLinks = [
  {
    id: 1,
    title: "Vitaliy Stefanyshyn Github Profile",
  ...
  {
    id: 2,
    title: "Vitaliy Stefanyshyn LinkedIn Profile",
  ...
  {
    id: 3,
    title: "Check Vitaliy Stefanyshyn on Dev.to",
  ...
  {
    id: 4,
    title: "Vitaliy Stefanyshyn Profile on Facebook",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
