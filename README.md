...
<p align="center">
  <a href="https://pagespeed.web.dev/report?url=https%3A%2F%2Fsatnaing.dev%2F&form_factor=desktop">
    <img width="710" alt="Vitaliy Stefanyshyn Portfolio Website Lighthouse Score" src="public/lighthouse-result.svg">
  <a>
</p>
...
```bash
git clone https://github.com/Vitaly-Stefanyshyn777/my-portfolio.git
